class Categorizer
  SCHEDULE = {
    '(куртка|пуховик|бомбер|тренч|пальто|накидк|плащ|шуба|ветровка|парка|жилетка|кардиган|пиджак|болеро|портупея|жакет)' => 2, # Верхняя одежда
    ...
    '(свитер|туника|кардиган|худи|батник|кофт|рубашка|блуз|футболка|майка|сорочка|боди|водолазка)' => 5, # Футболки,блузы,свитера
